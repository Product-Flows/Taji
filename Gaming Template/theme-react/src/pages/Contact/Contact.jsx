    ...
    return (
        <div className="p-4 sm:ml-56">
            <div className="container mx-auto my-5 lg:my-20 p-5">
                <div className="bg-black dark:bg-black h-full p-10 rounded-lg">
                        ...
                        <div className="col-span-1 lg:col-span-6">
                            <div>
                                ...
                                <div className='my-10'>
                                    ...
                                    <Link to={`mailto:productflowstech@gmail.com`} target="_self" className="text-[#5AC4D1] text-base font-medium leading-[30px]">
                                    productflowstech@gmail.com
                                    </Link>
                                </div>
                            </div>
                        </div>
